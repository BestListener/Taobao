...
String delurl = "/JDWeb/servlet/admin/stopUser?"+params[1]+"&page=";
  ...
  <head>
	...
	<script type="text/javascript">
		...
		//  点击查看按钮
  		...
  		//  点击停用按钮
  		function clickStopBtn(obj)
  		{
  			var id = obj.parentNode.parentNode.id;
  			var name = document.getElementById("name"+id);
  			if( window.confirm("确定停用  "+name.innerText+" 用户帐号的使用?") )
  			{
  ...
  <body onload="init()">
    <table id="orderTab">
		...
		<tr id="<%=user.get("uid") %>">
			...
			<td class="state"><%=user.get("state") %></td>
			<td class="operation">
				<div class="checkBtn" onclick="clickCheckBtn(this)" onmouseover="inCheckBtn(this)" onmouseout="outCheckBtn(this)">查看</div>
				<div class="stopBtn" onclick="clickStopBtn(this)" onmouseover="instopBtn(this)" onmouseout="outstopBtn(this)">停用</div>
			</td>
		</tr>
		<%
				}
