...
@WebServlet("/servlet/updateShoppingCartNum")
public class updateShoppingCartNum extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String scid = request.getParameter("id").toString();
		String params[] = {num,payAmount,scid};
		if( service.updateUserSCInfo(params) )
		{
			out.print("true");
		}
		else
