...
@MultipartConfig
@WebServlet("/servlet/upLoadProductImage")
public class upLoadProductImage extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//存储路径
        String savePath = request.getServletContext().getRealPath("/uploadFile/product");
        //获取上传的文件集合
...
//        System.out.println(savePath+File.separator+fileName);
        String localhostPath = "uploadFile/product/" + fileName;
